...
| `performance` | 500 seeded cards: opens within 10 s (dev-server regression guard), zoom holds >30 fps with no frame over 500 ms (F1). Numbers are printed as `F1 open ...` |
