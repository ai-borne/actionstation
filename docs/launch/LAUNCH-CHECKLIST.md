...
- [ ] B12 **Razorpay account shared with SSBMax.** Decided 2026-09-25: one account. ActionStation LIVE, SSBMax on TEST keys (separate modes, no collision). Open: SSBMax go-live and live proof of its filter; live webhook keeps 7 events deliberately. See `docs/payments/PAYMENT-STATE.md` `(You)` → [evidence](LAUNCH-EVIDENCE.md#b12)
