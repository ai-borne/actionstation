...
| Monitoring alerts | 9 enabled alert policies (+2 uptime policies) and 8 log metrics on channel `Eden Alerts` (email); `webhook_processing_error` alert added 2026-09-20. Fixed for gen2 on 2026-09-20 (were dead). Email delivery unproven until a real alert fires |
