export const settingsStrings = {
    ...
    exportDataDescription: 'Download current workspace nodes and connections as JSON',
    exportAllData: 'Export All My Data',
    exportAllDataDescription: 'Download your complete data — all workspaces, notes, and knowledge bank entries (GDPR Article 20)',
    exportAllLoading: 'Preparing export...',
    exportAllSuccess: 'All data exported successfully.',
    exportAllFailed: 'Failed to export data. Please try again.',
